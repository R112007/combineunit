...
/**
 * 替换原版 BuildingTetherPayloadUnit 的组合单位实体。
 ...
 */
public class CBuildingTetherPayloadUnit extends BuildingTetherPayloadUnit implements ComboUnit{
    /** 组合标记：同队同 ID 且在范围内的单位共享承伤/修复。0 = 未组合。 */
    public double comboId;

    public CBuildingTetherPayloadUnit(){}
