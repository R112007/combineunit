...
import mindustry.gen.PayloadUnitLegacyOct;

/**
 * 替换原版 PayloadUnitLegacyOct 的组合单位实体。
 ...
 */
public class CPayloadUnitLegacyOct extends PayloadUnitLegacyOct implements ComboUnit{
    /** 组合标记：同队同 ID 且在范围内的单位共享承伤/修复。0 = 未组合。 */
    public double comboId;

    public CPayloadUnitLegacyOct(){}
